...
export class BatchService {
    ...
    private convertDateFromClient(batch: IBatch): IBatch {
        const copy: IBatch = Object.assign({}, batch, {
            ...
            createdAt: batch.createdAt != null && batch.createdAt.isValid() ? batch.createdAt.toJSON() : null,
            updatedAt: batch.updatedAt != null && batch.updatedAt.isValid() ? batch.updatedAt.toJSON() : null
        });
        return copy;
    }
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((batch: IBatch) => {
            ...
            batch.createdAt = batch.createdAt != null ? moment(batch.createdAt) : null;
            batch.updatedAt = batch.updatedAt != null ? moment(batch.updatedAt) : null;
        });
        return res;
    }
}
