...
export class ShadeAreaService {
    ...
    private convertDateFromClient(shadeArea: IShadeArea): IShadeArea {
        const copy: IShadeArea = Object.assign({}, shadeArea, {
            ...
            createdAt: shadeArea.createdAt != null && shadeArea.createdAt.isValid() ? shadeArea.createdAt.toJSON() : null,
            updatedAt: shadeArea.updatedAt != null && shadeArea.updatedAt.isValid() ? shadeArea.updatedAt.toJSON() : null
        });
        return copy;
    }
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((shadeArea: IShadeArea) => {
            ...
            shadeArea.createdAt = shadeArea.createdAt != null ? moment(shadeArea.createdAt) : null;
            shadeArea.updatedAt = shadeArea.updatedAt != null ? moment(shadeArea.updatedAt) : null;
        });
        return res;
    }
}
