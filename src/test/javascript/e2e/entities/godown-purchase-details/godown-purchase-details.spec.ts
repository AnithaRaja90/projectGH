...
describe('GodownPurchaseDetails e2e test', () => {
    ...
    it('should create and save GodownPurchaseDetails', () => {
        ...
        godownPurchaseDetailsUpdatePage.setCreatedByInput('5');
        expect(godownPurchaseDetailsUpdatePage.getCreatedByInput()).toMatch('5');
        godownPurchaseDetailsUpdatePage.setModifiedByInput('5');
        expect(godownPurchaseDetailsUpdatePage.getModifiedByInput()).toMatch('5');
        godownPurchaseDetailsUpdatePage.setCreatedAtInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
        expect(godownPurchaseDetailsUpdatePage.getCreatedAtInput()).toContain('2001-01-01T02:30');
        godownPurchaseDetailsUpdatePage.setUpdatedAtInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
        expect(godownPurchaseDetailsUpdatePage.getUpdatedAtInput()).toContain('2001-01-01T02:30');
