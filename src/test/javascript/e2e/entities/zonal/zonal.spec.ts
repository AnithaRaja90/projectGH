...
describe('Zonal e2e test', () => {
    ...
    it('should create and save Zonals', () => {
        ...
        zonalUpdatePage.setCreatedByInput('5');
        expect(zonalUpdatePage.getCreatedByInput()).toMatch('5');
        zonalUpdatePage.setModifiedByInput('5');
        expect(zonalUpdatePage.getModifiedByInput()).toMatch('5');
